...
<script runat="server">
    ...
    {
        return true; //(!String.IsNullOrEmpty(Request["AUTH_USER"]) && ConfigurationManager.AppSettings["Administrators"].Contains(Request["AUTH_USER"].ToLower()));
    }
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "http://artman.ucoz.com";
        LicenseKey = "2PF5D5EX3MXRB";

        // The base URL used to reach files in CKFinder through the browser.
        BaseUrl = "~/Images/Product/ImageBrowser/";
